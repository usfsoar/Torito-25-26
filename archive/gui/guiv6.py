...
class GroundStationWindow(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Liquid Propulsion Ground Station - guiv6")
    ...
    def _build_ui(self) -> None:
        ...
        self.estop_indicator = QtWidgets.QLabel("Shift+A E-STOP")
        self.estop_indicator.setObjectName("estopIndicator")
        self.estop_indicator.setMinimumWidth(132)
    ...
    def refresh_gui(self) -> None:
        ...
        for i, label in enumerate(self.pressure_labels):
            ...
            label.setStyleSheet(
                ...
                "color: #101318; border: 2px solid #0b0d10; "

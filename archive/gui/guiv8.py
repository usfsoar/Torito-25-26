...
class GroundStationWindow(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Liquid Propulsion Ground Station - guiv8")
    ...
    def _build_ui(self) -> None:
        ...
        self.sensor_editor_button.clicked.connect(self.open_sensor_editor)
    ...
    def set_controls_enabled(self, enabled: bool) -> None:
        ...
        if hasattr(self, "sensor_editor_button"):
            self.sensor_editor_button.setEnabled(enabled)
